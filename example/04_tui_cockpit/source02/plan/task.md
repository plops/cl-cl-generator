...
- [x] Run the generator to output the files into `source02/`
- [x] Run Rove unit and integration tests to verify parser and state logic
- [x] Run the interactive TUI cockpit locally and verify keyboard interaction
