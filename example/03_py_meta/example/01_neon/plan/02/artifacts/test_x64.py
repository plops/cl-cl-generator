...
# Convert initial guesses to float64
...
for m in [20.0, 21.0, 22.0]:
    print(f"\n--- Mass = {m} (x64) ---")
    solver_initial = jaxopt.LBFGS(fun=initial_state_energy_reg, maxiter=800, tol=1e-12)
    ...
    solver_final = jaxopt.LBFGS(fun=final_state_energy_reg, maxiter=800, tol=1e-12)
