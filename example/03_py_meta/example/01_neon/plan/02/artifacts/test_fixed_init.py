...
def nominal_frequency_wrapper_fixed_init(nuclear_mass):
    # Compute initial guesses at a fixed mass of 20.18
...
m = 21.0
grad_fn = jax.grad(nominal_frequency_wrapper_fixed_init)
print("Computing jax.grad with fixed init mass...")
grad_val = grad_fn(m)
print(f"jax.grad: {grad_val}")

print("Computing finite differences...")
nu_plus = nominal_frequency_wrapper_fixed_init(22.0)
nu_minus = nominal_frequency_wrapper_fixed_init(20.0)
