...
for m in [20.0, 21.0, 22.0]:
    print(f"\n--- Mass = {m} (Actual Mass Init, x64) ---")
    x_1s, x_2s, x_5s, x_2p, x_3p = get_initial_guesses(m)
    ...
    solver_initial = jaxopt.LBFGS(fun=initial_state_energy_reg, maxiter=1000, tol=1e-10)
    ...
    solver_final = jaxopt.LBFGS(fun=final_state_energy_reg, maxiter=1000, tol=1e-10)
