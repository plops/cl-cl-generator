(eval-when (:compile-toplevel :execute :load-toplevel)
  ...
  (load (merge-pathnames "source01/dock.lisp" *load-pathname*)))

(in-package :cl-dockerfile-generator)

;; Generate 02_agy_env/Dockerfile
(let ((agy-env-code
        `(toplevel
           (comment "=====================================================================")
  ...
  (write-df (merge-pathnames "source01/examples/02_agy_env/Dockerfile" (asdf:system-relative-pathname :cl-cl-generator "example/05_dockerfile_meta/")) agy-env-code t)
  (format t "Generated 02_agy_env/Dockerfile successfully.~%"))

;; Generate 01_gentoo/Dockerfile
(let ((gentoo-code
        `(toplevel
...
EOF)))
 ...
 && rm -rf /tmp/fw_original /tmp/fw_nv_root))
  ...
  (write-df (merge-pathnames "source01/examples/01_gentoo/Dockerfile" (asdf:system-relative-pathname :cl-cl-generator "example/05_dockerfile_meta/")) gentoo-code t)
  (format t "Generated 01_gentoo/Dockerfile successfully.~%"))
